...
SELECT DISTINCT 
	   ...
	   SUM(T2.Quantity) AS 'QUANTIDADE DEVOLUÇÃO'
	   --t2.docdate
...
SELECT 
	   ...
	   ,ISNULL(T0.[DESCRIÇÃO ITEM],T1.[DESCRIÇÃO ITEM])  AS 'DESCRIÇÃO ITEM'
	   ...
	   ,CAST((T0.[QUANTIDADE DEVOLUÇÃO]+T1.[QUANTIDADE DEVOLUÇÃO])AS decimal) AS 'QUANTIDADE DEVOLUÇÃO'
